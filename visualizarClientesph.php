                            ...
                            <div class="content-box-large">
                                ...
                                <div class="content-box-large">
                                    ...
                                    <div class="panel-body">
                                        <table cellpadding="0" cellspacing="0" border="0" class="table table-responsive table-bordered" id="example" align="center">
                                            <thead>
                                                <tr>
                                                    <th>Cód</th>
                                                    <th>Nome</th>
                                            ...
                                            <tbody>
                                                ...
                                                <!-- Aqui vai a chamada do DAO -->
                                                <?php
                                                    include("serverside/exibirClientes.php");
                                                    $db->exibirListaClientes();
                                                ?>
